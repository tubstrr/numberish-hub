 ...
 <div class="w-full min-h-40">
  ...
  <div class="flex gap-4 flex-col">
   <NuxtFormField label="Message">
    <NuxtTextarea v-model="message" placeholder="Enter the encrypted message" class="w-full" autoresize />
   </NuxtFormField>
   ...
   <div class="flex gap-4">
    ...
    <!-- Share Button -->
    <NuxtButton :disabled="!shareLink" icon="i-lucide-share" variant="ghost" @click="share">
     Shareable Link
    </NuxtButton>
   </div>
  </div>
